    ...
    public void showProgressBar(boolean state) {
        ...
        public class getMenuCategory extends AsyncTask<String,String,String> {
            ...
            protected String doInBackground(String... strings) {
                ...
                JSONObject jsonObjectResponse=jsonParser.makeHttpRequest(AppConfig.protocal+AppConfig.hostname+AppConfig.get_menu_page,
                        "GET",jsonObjectData);
                ...
                try{
                    ...
                    oderId=jsonObjectResponse.getJSONArray("oderId");

                    JSONObject jb=oderId.getJSONObject(0);


                    AppConfig.orderId=jb.getString("orderId");
            ...
            protected void onPostExecute(String s){
                ...
                if(successState==1){
                    gridView.setAdapter(new MenuCategoryAdapter(MenuCategoryItems.this,AppConfig.menuCategoryName,AppConfig.menuCategoryId));
                    gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            AppConfig.menuCatName=txtName.getText().toString();
                              ...
                              startActivity(new Intent(MenuCategoryItems.this,MenuSubCategory.class));
