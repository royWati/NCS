...
public class cashierViewOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        textView=(TextView)findViewById(R.id.showText_for_unpaid);
        new getUnpaidItem().execute();
    ...
    public class getUnpaidItem extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            JSONObject jsonObjectResponse=jsonParser.makeHttpRequest(AppConfig.protocal+AppConfig.hostname+AppConfigCashier.get_unpaid_orders,
                    "GET",jsonObjectData);
            ...
            //    AppConfigCashier.order_item_id=new String[unpaidOrder.length()];
                AppConfigCashier.order_id=new String[unpaidOrder.length()];
...
//                    Log.d("kit-order id",AppConfigCashier.order_item_id[i]);
        ...
        protected void onPostExecute(String s){
            ...
            if(successState==1){
           listView.setAdapter(new CashierViewOrderAdapter(cashierViewOrders.this,AppConfigCashier.order_id,AppConfigCashier.price));
           listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
               @Override
               public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                   TextView textView=(TextView)view.findViewById(R.id.order_num_cash_unpaid);
                   AppConfigCashier.orderNumber=textView.getText().toString();
                   TextView text=(TextView)view.findViewById(R.id.item_price_cash_unpaid);
                   AppConfigCashier.amount=text.getText().toString();

                   startActivity(new Intent(cashierViewOrders.this,MakePayment.class));
               }
           });
            }
            else{
