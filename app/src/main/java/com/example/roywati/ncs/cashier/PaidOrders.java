...
public class PaidOrders extends AppCompatActivity{
    ...
    public class getPaidItem extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            JSONObject jsonObjectResponse=jsonParser.makeHttpRequest(AppConfig.protocal+AppConfig.hostname+AppConfigCashier.get_paid_orders,
                    "GET",jsonObjectData);
  ...
  //                  Log.d("kit-order id",AppConfigCashier.order_item_id[i]);
        ...
        protected void onPostExecute(String s){
            ...
            if(successState==1){
                ...
                listView.setAdapter(new PaidOrdersAdapter(PaidOrders.this,AppConfigCashier.order_id,AppConfigCashier.price));
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        startActivity(new Intent(PaidOrders.this,PrintActivity.class));
                    }
                });
            }
            else{
